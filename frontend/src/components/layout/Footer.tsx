...
import { Wifi, Facebook, Mail, MapPin, Shield, Clock, Headphones } from 'lucide-react';
        ...
        <div className="container py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              { icon: Wifi, label: '4G/5G Networks', sub: '100+ countries' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Your trusted partner for global connectivity. Buy eSIM online for travel with instant digital delivery.
            </p>
            <div className="flex gap-3">
              ...
              <a
                href="mailto:support@esimglobal.com"
                className="w-9 h-9 bg-gray-800 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-colors"
                aria-label="Email"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              {[
                { name: 'Vietnam eSIM', slug: 'vietnam' },
                { name: 'Japan eSIM', slug: 'japan' },
                { name: 'Thailand eSIM', slug: 'thailand' },
                { name: 'Singapore eSIM', slug: 'singapore' },
                { name: 'USA eSIM', slug: 'united-states' },
                { name: 'Europe eSIM', slug: 'europe' },
              ].map(({ name, slug }) => (
                <li key={slug}>
                  <Link
                    href={`/countries/${slug}`}
      ...
      <div className="border-t border-gray-800">
        <div className="container py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} eSIM Global. All rights reserved.
          </p>
